...
echo "========================================"
echo "先复制一份配置文件，例如："
echo "cp /etc/tcp_pool/default.conf /etc/tcp_pool/hk.conf，这个hk用来区分不同转发，就是你可以写us，jp，hk01，hk02等，代表不同的落地，用于创建多个转发"
echo "用nano /etc/tcp_pool/hk.conf编辑配置文件，nano我装好了，hk改成你上面自己写的us或者jp"
echo "然后填写好配置文件"
